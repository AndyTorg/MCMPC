function varargout = SolarGUI10092013_proportional(varargin)
% SOLARGUI10092013_PROPORTIONAL MATLAB code for SolarGUI10092013_proportional.fig
%      SOLARGUI10092013_PROPORTIONAL, by itself, creates a new SOLARGUI10092013_PROPORTIONAL or raises the existing
%      singleton*.
%
%      H = SOLARGUI10092013_PROPORTIONAL returns the handle to a new SOLARGUI10092013_PROPORTIONAL or the handle to
%      the existing singleton*.
%
%      SOLARGUI10092013_PROPORTIONAL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SOLARGUI10092013_PROPORTIONAL.M with the given input arguments.
%
%      SOLARGUI10092013_PROPORTIONAL('Property','Value',...) creates a new SOLARGUI10092013_PROPORTIONAL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SolarGUI10092013_proportional_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SolarGUI10092013_proportional_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SolarGUI10092013_proportional

% Last Modified by GUIDE v2.5 09-Oct-2013 07:50:11
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SolarGUI10092013_proportional_OpeningFcn, ...
                   'gui_OutputFcn',  @SolarGUI10092013_proportional_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% varargin   command line arguments to SolarGUI10092013_proportional (see VARARGIN)
% Choose default command line output for SolarGUI10092013_proportional
...
% UIWAIT makes SolarGUI10092013_proportional wait for user response (see UIRESUME)
