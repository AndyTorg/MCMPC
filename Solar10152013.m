function varargout = Solar10152013(varargin)
% SOLAR10152013 MATLAB code for Solar10152013.fig
%      SOLAR10152013, by itself, creates a new SOLAR10152013 or raises the existing
%      singleton*.
%
%      H = SOLAR10152013 returns the handle to a new SOLAR10152013 or the handle to
%      the existing singleton*.
%
%      SOLAR10152013('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SOLAR10152013.M with the given input arguments.
%
%      SOLAR10152013('Property','Value',...) creates a new SOLAR10152013 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Solar10152013_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Solar10152013_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Solar10152013_OpeningFcn, ...
                   'gui_OutputFcn',  @Solar10152013_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Solar10152013 is made visible.
function Solar10152013_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Solar10152013 (see VARARGIN)

% Choose default command line output for Solar10152013
